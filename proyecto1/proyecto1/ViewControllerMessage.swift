...
class ViewControllerMessage: UIViewController {
    ...
    var loveQuotes = ["Hay amores tan bellos que justifican todas las locuras que hacen cometer.\nPlutarco", "Cierto que en el mundo de los hombres nada hay necesario, excepto el amor.\nGoethe", "Hay un camino seguro para llegar a todo corazón: el amor.\nConcepción Arenal", "El amor sólo descansa cuando muere. Un amor vivo es un amor en conflicto.\nPaulo Coelho", "No ser amados es una simple desventura; la verdadera desgracia es no amar.\nAlbert Camus", "Ni la ausencia ni el tiempo son nada cuando se ama.\nAlfred de Musset", "En asuntos de amor, los locos son los que tienen más experiencia. De amor no preguntes nunca a los cuerdos; los cuerdos aman cuerdamente, que es como no haber amado nunca.\nJacinto Benavente", "Qué lástima que pase el tiempo ¿verdad?, qué lástima que nos muramos y que nos hagamos viejos y que las cosas buenas se vayan alejando de nosotros al galope.\nRoberto Bolaño", "El que ha conocido solo a su mujer y la ha amado, sabe más de mujeres que el que ha conocido mil. Leon Tolstoi", "Hay que saber que no existe país sobre la tierra donde el amor no haya convertido a los amantes en poetas.\nVoltaire", "El amor es el anhelo de salir de uno mismo.\nCharles Baudelaire", "Un beso legal nunca vale tanto como un beso robado.\nGuy de Maupassant", "Las cartas de amor se empiezan sin saber lo que se va a decir y se terminan sin saber lo que se ha dicho.\nJean-Jacques Rousseau", "El amor es tan importante como la comida. Pero no alimenta.\nGarcía Márquez", "Donde no hay amor, poned amor y encontraréis amor.\nSan Juan de la Cruz", "Te amo por encima de todo aquello que no podemos ver, por encima de lo que no podemos conocer.\nFederico Moccia", "Es tan corto el amor y es tan largo el olvido…\nPablo Neruda", "Sabes que estas enamorado cuando no quieres acostarte porque la realidad es por fin mejor que tus sueños.\nDr. Seuss", "Ama un solo día y el mundo habrá cambiado.\nRobert Browning", "El que puede prescindir del ser amado puede prescindir de todo.\nAndré Maurois"]
